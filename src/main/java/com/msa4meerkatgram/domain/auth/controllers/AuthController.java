...
import com.msa4meerkatgram.global.annotation.openapi.ApiUnauthenticatedResponse;
...
// @Tag: API들을 기능별 또는 도메인 별로 그룹화 할 때 사용
@Tag(name = "인증API", description = "인증 및 인가 담당")
@RestController
