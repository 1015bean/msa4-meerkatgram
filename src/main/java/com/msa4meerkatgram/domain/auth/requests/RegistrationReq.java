...
public record RegistrationReq (
    ...
    @Schema(description = "닉네임", nullable = false, requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "닉네임은 필수 항목입니다.")
    @Pattern(regexp = "^[0-9a-zA-Z]{2,20}$", message = "허용하지 않는 닉네임 양식입니다.")
    String nick,

    @Schema(description = "프로필", example = "프로필 사진 링크", nullable = false, requiredMode = Schema.RequiredMode.REQUIRED)
